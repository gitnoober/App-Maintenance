...
class XlsDoc:
    ...
    def _build_directory(self):  # align on sector boundary
        ...
        self.dir_stream += struct.pack(
            "<64s H 2B 3l 9L l L L",
    ...
    def _build_sat(self):
        ...
        while (
            total_sect_count > 128 * SAT_sect_count
            or SAT_sect_count > SAT_sect_count_limit
        ):
            SAT_sect_count += 1
            total_sect_count += 1
        ...
        self.packed_MSAT_2nd = struct.pack(
            "<%dl" % (MSAT_sect_count * 128), *MSAT_2nd
        )
