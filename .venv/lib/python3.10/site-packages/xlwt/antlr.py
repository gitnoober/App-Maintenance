...
class NoViableAltException(RecognitionException):
    def __init__(self, *args):
        ...
        if isinstance(args[0], AST):
            ...
            raise TypeError(
                "NoViableAltException requires Token or AST argument"
            )
    ...
    def __str__(self):
        if self.token:
            ...
            return 'unexpected symbol at line %s (column %s): "%s"' % (
                line,
                col,
                text,
            )
...
class NoViableAltForCharException(RecognitionException):
    def __init__(self, *args):
        ...
        if len(args) == 2:
            ...
            column = args[3]
            RecognitionException.__init__(
                self, "NoViableAlt", fileName, line, column
            )
        else:
...
class MismatchedCharException(RecognitionException):
    ...
    def __str__(self):
        ...
        if self.mismatchType == MismatchedCharException.CHAR:
        ...
        elif self.mismatchType in [
            MismatchedCharException.RANGE,
            MismatchedCharException.NOT_RANGE,
        ]:
            ...
            MismatchedCharException.NOT_SET,
        ]:
            sb.append("expecting ")
...
class MismatchedTokenException(RecognitionException):
    ...
    def __str__(self):
        ...
        if self.mismatchType == MismatchedTokenException.TOKEN:
            ...
            MismatchedTokenException.RANGE,
            MismatchedTokenException.NOT_RANGE,
        ]:
            ...
            MismatchedTokenException.NOT_SET,
        ]:
            sb.append("expecting ")
...
class TokenStreamRecognitionException(TokenStreamException):
    def __init__(self, *args):
        if args and isinstance(args[0], RecognitionException):
            ...
            raise TypeError(
                "TokenStreamRecognitionException requires RecognitionException argument"
            )
...
class TokenStreamSelector(TokenStream):
    ...
    def select(self, arg):
        ...
        if is_string_type(arg):
            ...
            return
        raise TypeError(
            "TokenStreamSelector.select requires "
...
class TokenStreamBasicFilter(TokenStream):
    ...
    def discard(self, arg):
        ...
        if isinstance(arg, BitSet):
            ...
            return
        raise TypeError(
            "TokenStreamBasicFilter.discard requires"
...
class TokenStreamHiddenTokenFilter(TokenStreamBasicFilter):
    ...
    def consumeFirst(self):
        ...
        p = None
        while self.hideMask.member(
            self.LA(1).getType()
        ) or self.discardMask.member(self.LA(1).getType()):
...
class BitSet(object):
    ...
    def __init__(self, data=None):
        ...
        if not isinstance(data, list):
            raise TypeError(
                "BitSet requires integer, long, or " + "list argument"
            )
        for x in data:
            if not isinstance(x, int_types):
                raise TypeError(
                    self, "List argument item is " + "not a long: %s" % (x)
                )
        self.data = data
...
def illegalarg_ex(func):
    raise ValueError(
        "%s is only valid if parser is built for debugging" % (func.func_name)
    )
...
class TreeParser(object):
    ...
    def matchNot(self, t, ttype):
        if not t or (t == ASTNULL) or (t.getType() == ttype):
            raise MismatchedTokenException(
                self.getTokenNames(), t, ttype, True
            )
...
class BaseAST(AST):
    ...
    def doWorkForFindAll(self, v, target, partialMatch):
        ...
        while sibling:
            ...
            if sibling.getFirstChild():
                sibling.getFirstChild().doWorkForFindAll(
                    v, target, partialMatch
                )
    ...
    def equalsTree(self, t):
        return self.equals(t) and cmptree(
            self.getFirstChild(), t.getFirstChild(), partial=False
        )
