...
class UserFields(object):
    ...
    def loaddoc(self):
        if (
            ...
            and (
                isinstance(self.src_file, str)
                or (isinstance(self.src_file, io.IOBase))
            )
        ) or (
            sys.version_info[0] == 2 and isinstance(self.src_file, basestring)
        ):
    ...
    def list_fields_and_values(self, field_names=None):
        ...
        for f in all_fields:
            ...
            if field_names is None or field_name in field_names:
                found_fields.append((field_name, value_type, value))
        return found_fields
