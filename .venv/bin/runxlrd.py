#!/home/ps/Documents/App-Maintenance/.venv/bin/python3
...
if __name__ == "__main__":
    ...
    def print_labels(sh, labs, title):
        ...
        for rlo, rhi, clo, chi in labs:
            print(
                ...
                % (
                    title,
                    xlrd.cellname(rlo, clo),
                    xlrd.cellname(rhi - 1, chi - 1),
                )
            )
    ...
    def main(cmd_args):
        ...
        oparser.add_option(
            "-e", "--encoding", default="", help="encoding override"
        )
        oparser.add_option(
            "-f",
            "--formatting",
        ...
        if mmap_opt in (1, 0):
            ...
            print(
                "Unexpected value (%r) for mmap option -- assuming default"
                % mmap_opt
            )
