...
class diff_match_patch:
        ...
        while pointer < len(diffs):
            if diffs[pointer][0] == self.DIFF_INSERT:
                ...
                if count_delete >= 1 and count_insert >= 1:
                    ...
                    pointer = (
                        pointer - count_delete - count_insert + len(subDiff)
                    )
                count_insert = 0
                count_delete = 0
                text_delete = ""
    ...
    def diff_bisect(self, text1, text2, deadline):
        ...
        for d in range(max_d):
            ...
            for k1 in range(-d + k1start, d + 1 - k1end, 2):
                ...
                if k1 == -d or (
                    k1 != d and v1[k1_offset - 1] < v1[k1_offset + 1]
                ):
                    x1 = v1[k1_offset + 1]
                else:
                    x1 = v1[k1_offset - 1] + 1
            ...
            for k2 in range(-d + k2start, d + 1 - k2end, 2):
                ...
                if k2 == -d or (
                    k2 != d and v2[k2_offset - 1] < v2[k2_offset + 1]
                ):
                    x2 = v2[k2_offset + 1]
                else:
                    x2 = v2[k2_offset - 1] + 1
    ...
    def diff_cleanupEfficiency(self, diffs):
        ...
        pointer = 0  # Index of current position.
        pre_ins = (
            False  # Is there an insertion operation before the last equality.
        )
        pre_del = (
            False  # Is there a deletion operation before the last equality.
        )
        post_ins = (
            False  # Is there an insertion operation after the last equality.
        )
        post_del = (
            False  # Is there a deletion operation after the last equality.
        )
        while pointer < len(diffs):
            if diffs[pointer][0] == self.DIFF_EQUAL:  # Equality found.
    ...
    def match_bitap(self, text, pattern, loc):
        ...
        if best_loc != -1:
            score_threshold = min(
                match_bitapScore(0, best_loc), score_threshold
            )
    ...
    def patch_make(self, a, b=None, c=None):
        ...
        prepatch_text = (
            text1  # Recreate the patches to determine context info.
        )
        ...
        for x in range(len(patches)):
            ...
            while len(bigpatch.diffs) != 0:
                ...
                if postcontext:
                    ...
                    if (
                        len(patch.diffs) != 0
                        and patch.diffs[-1][0] == self.DIFF_EQUAL
                    ):
                        patch.diffs[-1] = (
                            self.DIFF_EQUAL,
