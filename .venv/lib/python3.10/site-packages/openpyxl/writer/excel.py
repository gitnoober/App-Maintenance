...
class ExcelWriter(object):
    ...
    def write_data(self):
        ...
        archive.writestr(
            ARC_CORE, tostring(self.workbook.properties.to_tree())
        )
    ...
    def _merge_vba(self):
        ...
        if self.workbook.vba_archive:
            for name in (
                set(self.workbook.vba_archive.namelist()) - self.vba_modified
            ):
    ...
    def _write_comment(self, ws):
        ...
        comment_rel = Relationship(
            Id="comments", type=cs._rel_type, Target=cs.path
        )
