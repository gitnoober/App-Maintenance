...
from openpyxl.descriptors.nested import NestedNoneSet, NestedText
...
from .graphic import GraphicFrame, GroupShape
from .picture import PictureFrame
from .relation import ChartRelation
from .xdr import XDRPoint2D, XDRPositiveSize2D
    ...
    def _write(self):
        ...
        for idx, obj in enumerate(self.charts + self.images, 1):
            ...
            if isinstance(obj, ChartBase):
                ...
                child = (
                    anchor.pic or anchor.groupShape and anchor.groupShape.pic
                )
                if not child:
