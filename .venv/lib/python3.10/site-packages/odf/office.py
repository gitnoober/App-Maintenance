...
def DocumentContent(version="1.2", **args):
    return Element(
        qname=(OFFICENS, "document-content"), version=version, **args
    )
...
def DocumentSettings(version="1.2", **args):
    return Element(
        qname=(OFFICENS, "document-settings"), version=version, **args
    )


def DocumentStyles(version="1.2", **args):
    return Element(
        qname=(OFFICENS, "document-styles"), version=version, **args
    )
