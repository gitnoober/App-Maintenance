...
from openpyxl.descriptors import Bool, Float, Integer, Set, String, Typed
from openpyxl.descriptors.excel import ExtensionList, Guid
...
class CommentSheet(Serialisable):
    ...
    def comments(self):
        ...
        for c in self.commentList:
            yield c.ref, Comment(
                c.content, authors[c.authorId], c.height, c.width
            )
