...
class PyPy(ViaGlobalRefVirtualenvBuiltin):
    ...
    def can_describe(cls, interpreter):
        return interpreter.implementation == "PyPy" and super(
            PyPy, cls
    ...
    def _executables(cls, interpreter):
        ...
        targets = sorted(
            "{}{}".format(name, PyPy.suffix)
            for name in cls.exe_names(interpreter)
        )
        must = (
            RefMust.COPY if interpreter.version_info.major == 2 else RefMust.NA
        )
