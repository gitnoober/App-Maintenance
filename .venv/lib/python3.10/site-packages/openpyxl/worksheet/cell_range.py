...
from openpyxl.descriptors import MinMax, Sequence, Strict
...
class CellRange(Serialisable):
    ...
    def __superset(self, other):
        ...
        ) and (self.min_col <= other.min_col <= other.max_col <= self.max_col)
    ...
    def intersection(self, other):
        ...
        if self.isdisjoint(other):
            raise ValueError(
                "Range {0} doesn't intersect {0}".format(self, other)
            )
