...
from openpyxl.descriptors import MinMax, Strict, String, Typed
...
class Reference(Strict):
    ...
    def rows(self):
        ...
        for row in range(self.min_row, self.max_row + 1):
            yield Reference(
                self.worksheet, self.min_col, row, self.max_col, row
            )
    ...
    def cols(self):
        ...
        for col in range(self.min_col, self.max_col + 1):
            yield Reference(
                self.worksheet, col, self.min_row, col, self.max_row
            )
