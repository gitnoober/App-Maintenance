...
class DiffTest(DiffMatchPatchTest):
    ...
    def testDiffCommonPrefix(self):
        ...
        # Non-null case.
        self.assertEquals(
            4, self.dmp.diff_commonPrefix("1234abcdef", "1234xyz")
        )
    ...
    def testDiffCommonSuffix(self):
        ...
        # Non-null case.
        self.assertEquals(
            4, self.dmp.diff_commonSuffix("abcdef1234", "xyz1234")
        )
    ...
    def testDiffCommonOverlap(self):
        ...
        # Overlap.
        self.assertEquals(
            3, self.dmp.diff_commonOverlap("123456xxx", "xxxabcd")
        )
    ...
    def testDiffHalfMatch(self):
        ...
        # No match.
        self.assertEquals(
            None, self.dmp.diff_halfMatch("1234567890", "abcdef")
        )
    ...
    def testDiffLinesToChars(self):
        ...
        lineList.insert(0, "")
        self.assertEquals(
            (chars, "", lineList), self.dmp.diff_linesToChars(lines, "")
        )
    ...
    def testDiffCleanupMerge(self):
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEquals(
            [(self.dmp.DIFF_DELETE, "abc"), (self.dmp.DIFF_EQUAL, "acx")],
            diffs,
        )
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEquals(
            [(self.dmp.DIFF_EQUAL, "xca"), (self.dmp.DIFF_DELETE, "cba")],
            diffs,
        )
    ...
    def testDiffCleanupSemantic(self):
        ...
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEquals(
            [(self.dmp.DIFF_DELETE, "abcdef"), (self.dmp.DIFF_INSERT, "cdfg")],
            diffs,
        )
        ...
        self.assertEquals(
            [
                (self.dmp.DIFF_DELETE, "AB_AB"),
                (self.dmp.DIFF_INSERT, "1A2_1A2"),
            ],
            diffs,
        )
        ...
        diffs = [
            (self.dmp.DIFF_DELETE, "abcxx"),
            (self.dmp.DIFF_INSERT, "xxdef"),
        ]
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEquals(
            [(self.dmp.DIFF_DELETE, "abcxx"), (self.dmp.DIFF_INSERT, "xxdef")],
            diffs,
        )

        # Overlap elimination.
        diffs = [
            (self.dmp.DIFF_DELETE, "abcxxx"),
    ...
    def testDiffCleanupEfficiency(self):
        ...
        self.dmp.diff_cleanupEfficiency(diffs)
        self.assertEquals(
            [(self.dmp.DIFF_DELETE, "xcd"), (self.dmp.DIFF_INSERT, "12x34")],
            diffs,
        )
    ...
    def testDiffMain(self):
        ...
        texts_textmode = self.diff_rebuildtexts(
            self.dmp.diff_main(a, b, False)
        )
...
class MatchTest(DiffMatchPatchTest):
    ...
    def testMatchAlphabet(self):
        ...
        self.assertEquals(
            {"a": 4, "b": 2, "c": 1}, self.dmp.match_alphabet("abc")
        )

        self.assertEquals(
            {"a": 37, "b": 18, "c": 8}, self.dmp.match_alphabet("abcaba")
        )
    ...
    def testMatchBitap(self):
        ...
        self.assertEquals(
            2, self.dmp.match_bitap("abcdefghijk", "cdefxyhijk", 5)
        )
        ...
        # Overflow.
        self.assertEquals(
            2, self.dmp.match_bitap("123456789xx0", "3456789x0", 2)
        )
        ...
        # Multiple select.
        self.assertEquals(
            0, self.dmp.match_bitap("abcdexyzabcde", "abccde", 3)
        )

        self.assertEquals(
            8, self.dmp.match_bitap("abcdexyzabcde", "abccde", 5)
        )
