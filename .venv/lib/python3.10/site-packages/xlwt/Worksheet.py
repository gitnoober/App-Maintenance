...
class Worksheet(object):
    ...
    cols_right_to_left = property(
        get_cols_right_to_left, set_cols_right_to_left
    )
    ...
    vert_split_first_visible = property(
        get_vert_split_first_visible, set_vert_split_first_visible
    )
    ...
    horz_split_first_visible = property(
        get_horz_split_first_visible, set_horz_split_first_visible
    )
    ...
    show_auto_page_breaks = property(
        get_show_auto_page_breaks, set_show_auto_page_breaks
    )
    ...
    auto_style_outline = property(
        get_auto_style_outline, set_auto_style_outline
    )
    ...
    alt_formula_entries = property(
        get_alt_formula_entries, set_alt_formula_entries
    )
    ...
    row_default_height = property(
        get_row_default_height, set_row_default_height
    )
    ...
    print_centered_vert = property(
        get_print_centered_vert, set_print_centered_vert
    )
    ...
    print_centered_horz = property(
        get_print_centered_horz, set_print_centered_horz
    )
    ...
    fit_width_to_pages = property(
        get_fit_width_to_pages, set_fit_width_to_pages
    )
    ...
    fit_height_to_pages = property(
        get_fit_height_to_pages, set_fit_height_to_pages
    )
    ...
    print_notes_at_end = property(
        get_print_notes_at_end, set_print_notes_at_end
    )
    ...
    def insert_bitmap(
        self, filename, row, col, x=0, y=0, scale_x=1, scale_y=1
    ):
    ...
    def insert_bitmap_data(
        self, data, row, col, x=0, y=0, scale_x=1, scale_y=1
    ):
    ...
    def __bof_rec(self):
        return BIFFRecords.Biff8BOFRecord(
            BIFFRecords.Biff8BOFRecord.WORKSHEET
        ).get()
    ...
    def __guts_rec(self):
        ...
        if len(self.__cols) != 0:
            col_visible_levels = (
                max(self.__cols[c].level for c in self.__cols) + 1
            )
        return BIFFRecords.GutsRecord(
            self.__row_gut_width,
            self.__col_gut_height,
            self.__row_visible_levels,
            col_visible_levels,
        ).get()
    ...
    def __window2_rec(self):
        ...
        return BIFFRecords.Window2Record(
            options,
            self.__first_visible_row,
            self.__first_visible_col,
            self.__grid_colour,
            self.__preview_magn,
            self.__normal_magn,
            scl_magn,
            ...
            if not self.split_position_units_are_twips:
                ...
                if self.__vert_split_pos > 0:
                    self.__vert_split_pos = (
                        113.879 * self.__vert_split_pos + 390
                    )

            # when split, the active pain can be set as required:
            active_pane = self.active_pane

        result = BIFFRecords.PanesRecord(
            *map(
                int,
                (
                    self.__vert_split_pos,
    ...
    def __calc_settings_rec(self):
        ...
        result += BIFFRecords.IterationRecord(
            self.__iterations_on & 0x01
        ).get()
    ...
    def __print_settings_rec(self):
        ...
        result += BIFFRecords.HorizontalPageBreaksRecord(
            self.__horz_page_breaks
        ).get()
        result += BIFFRecords.VerticalPageBreaksRecord(
            self.__vert_page_breaks
        ).get()
        ...
        result += BIFFRecords.SetupPageRecord(
            self.__paper_size_code,
