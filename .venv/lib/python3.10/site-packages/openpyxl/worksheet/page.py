...
from openpyxl.descriptors import Bool, Float, Integer, NoneSet
from openpyxl.descriptors.excel import Relation, UniversalMeasure
...
class PageMargins(Serialisable):
    ...
    def __init__(
        self, left=0.75, right=0.75, top=1, bottom=1, header=0.5, footer=0.5
    ):
        self.left = left
        self.right = right
        self.top = top
