...
from openpyxl.descriptors import Alias, Bool, Float, Integer, Strict, String
...
class RowDimension(Dimension):
    ...
    def __init__(
        ...
        **kw
        ...
        super(RowDimension, self).__init__(
            index, hidden, outlineLevel, collapsed, worksheet, style=s
        )
...
class ColumnDimension(Dimension):
    ...
    def __init__(
        ...
        if outline_level is not None:
            outlineLevel = outline_level
        self.collapsed = collapsed
        super(ColumnDimension, self).__init__(
            index, hidden, outlineLevel, collapsed, worksheet, style=style
        )
